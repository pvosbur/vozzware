...
/**
 * This represents the soap:headerFault WSDL element
 *
...
{
  /**
   * Sets the message name attribute for this SOAP fault.
   *
  ...
  /**
   * Gets the message name attribute for this SOAP fault.
   *
  ...
  /**
   * Gets the soap:fault part attribute
   * @return the soap:fault part attribute
   */
...
} // end interface SOAPHeaderFault{}

// *** End of SOAPHeaderFault.java ***
