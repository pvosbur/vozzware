...
Source Name: VwRadioButton.java
...
/**
 * The VwRadioButton bean extends the Java Swing JCheckBox class giving extended
 ...
 * @version 2.0
 */
public class VwRadioButton extends JRadioButton
{
  ...
  /**
   * Constructs the VwRadioButton instance
   */
  public VwRadioButton()
  {
    super();
  ...
  /**
   * Constructs the VwRadioButton instance with text
   */
  public VwRadioButton( String strText )
  {
    super( strText );
    m_fEnabled = isEnabled();
  }
...
} // end class VwRadioButton{}


// *** End of VwRadioButton.java ***
