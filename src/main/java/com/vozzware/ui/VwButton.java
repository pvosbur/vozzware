...
*/
/**
 * The VwButton bean extends the Java Swing  JButton class giving extended
 ...
 * @version 2.0
 */
public class VwButton extends JButton
{
   ...
   * @param action
   */
  public VwButton( VwAction action )
  {
    super( action );
  ...
  /**
   * Constructs the VwButton instance
   */
  public VwButton()
  {
    super();
