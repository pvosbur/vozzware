...
Source Name: VwPasswordField.java
...
/**
 * This class extends the java JPasswordField class to add data validation and data aware
 * capabilites through the VwDataDictionary, Vw Servers, and VwEdit classes.
 * The VwPasswordField can limit the number and type of characters entered using the
 ...
 * sent to interested listeners.  The data in the VwPasswordField is formatted acording
 * to the edit mask defined when the text field looses focus.
 */
public class VwPasswordField extends JPasswordField implements VwServiceable
{
  ...
  /**
   * Constructs an VwPasswordField object
   */
  public VwPasswordField()
  {
    super();
    ...
    addKeyListener( new KeyAdapter(){
     public void keyTyped( KeyEvent ke )
     {
       ...
       if ( ke.isActionKey() || ke.getKeyCode() == KeyEvent.VK_DELETE ||
       ...
       if ( ch != (char)0 )
       {
         ...
         {
           m_fWantSuper = true;
           String strData = VwPasswordField.this.getText();
    ...
    addFocusListener( new FocusAdapter()
    {
      ...
      public void focusGained( FocusEvent fe )
      {
        ...
        VwPasswordField.this.focusGained();
      }
  ...
  /**
   * Adds a VwPasswordField Listener
   *
  ...
  private void focusGained()
  {
    ...
    if ( m_itcEdit.isNumeric() )
      super.setText( VwExString.numericStrip( new String( super.getPassword() ) ) );

    m_fWantSuper = true;
    if ( m_fMarkTextOnFocus )
      select( 0, super.getPassword().length );
  ...
  public final String getText()
  {
    ...
    if ( m_itcEdit.isNumeric() )
      return VwExString.numericStrip( new String( super.getPassword() ) );
...
} // end class VwPasswordField{}


// *** End of VwPasswordField.java ***
