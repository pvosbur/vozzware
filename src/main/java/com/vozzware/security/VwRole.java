...
public class VwRole
{
  ...
  private List                   m_listPrivilegeGroupRef;        
  ...
  /**
   * Sets the privilegeGroupRef property
   * 
   * @param listprivilegeGroupRef
   */
  public void setPrivilegeGroupRef( List listPrivilegeGroupRef )
  { m_listPrivilegeGroupRef = listPrivilegeGroupRef;
 }

  /**
   * Gets privilegeGroupRef property
   * 
   * @return  The privilegeGroupRef property
   */
  public List getPrivilegeGroupRef()
  { return m_listPrivilegeGroupRef; }
